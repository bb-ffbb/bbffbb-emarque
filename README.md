...
This project is not affiliated with FFBB (Fédération Française de Basket-Ball) but is just a personnal project and would and should be not use for commercial purpose.

FFBB Logos and Fonts are licensed. If you want use to remove logo from this repository, please contact project author (Alexandre Duros <alexandre.duros@gmail.com>)
